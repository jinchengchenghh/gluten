...
arrow::Result<std::shared_ptr<arrow::Buffer>> SubstraitFromJSON(std::string_view type_name, std::string_view json) {
...
arrow::Result<std::string> SubstraitToJSON(std::string_view type_name, const arrow::Buffer& buf) {
  std::string type_url = "/substrait." + std::string{type_name};
