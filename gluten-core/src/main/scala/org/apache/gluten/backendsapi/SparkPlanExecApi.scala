...
import org.apache.spark.sql.execution.{FileSourceScanExec, GenerateExec, LeafExecNode, ProjectExec, SparkPlan}
...
trait SparkPlanExecApi {
  ...
  def genSparkPartialProjectColumnarExec(original: ProjectExec, child: SparkPlan): GlutenPlan = null
